...
fabs(phoSCEta->at(i))<2.4 && fabs(phoSCEta->at(j))<2.4 && (fabs(phoSCEta->at(i)) < 1.4442 || fabs(phoSCEta->at(i)) > 1.566) && (fabs(phoSCEta->at(i)) < 1.4442 || fabs(phoSCEta->at(j)) > 1.566) 
  ...
  std::cout<< " numerator: "        << hnum->Integral(1,6) << endl;  
  std::cout<< " weight numerator: " << hnum_wt->Integral(1,6) << endl;  
  std::cout<< " Uncertainty numerator: " << hnum_uncert[0]->Integral(1,6) << endl;  

  cout << "  ratio of efficiency: " << hnum_wt->Integral(1,6)/hnum->Integral(1,6) << endl;  
  cout << "  uncertainty of efficiency: " << hnum_uncert[0]->Integral(1,6)/hnum->Integral(1,6) << endl;  
