...
process.tagProbeFitTreeAnalyzer = cms.EDAnalyzer("TagProbeFitTreeAnalyzer",
    # IO parameters:
    InputFileNames = cms.vstring("file:/afs/cern.ch/user/e/echapon/workspace/public/LbyL/EmiliensCode/TriggerEff/output%s_HFveto.root" % dataOrMC),
    InputDirectoryName = cms.string("trigTree_%s" % (type)),
    InputTreeName = cms.string("fitter_tree"),
    OutputFileName = cms.string("tnp_Ana_%s_%s_HFveto.root" % ( dataOrMC, type )),
