                  ...
                  for(int aa = 0 ; aa <nMC; ++aa ){    
                     for(int bb = aa+1 ; bb <nMC; ++bb ){    
                        ...
                        if(true){ 
                           ...
                           if (getDR(phoSCEta->at(i), phoSCPhi->at(i), mcEta->at(aa), mcPhi->at(aa)) < 1 || 
                                 getDR(phoSCEta->at(j), phoSCPhi->at(j), mcEta->at(bb), mcPhi->at(bb)) < 1 ||	
                                 getDR(phoSCEta->at(i), phoSCPhi->at(i), mcEta->at(bb), mcPhi->at(bb)) < 1 || 
                                 getDR(phoSCEta->at(j), phoSCPhi->at(j), mcEta->at(aa), mcPhi->at(aa)) < 1) {
