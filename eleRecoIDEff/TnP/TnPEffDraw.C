...
const char* fDataName = "tnp_Ana_Data_GSF_recoIDEle.root";
const char* fMCName = "tnp_Ana_MC_GSF_recoIDEle.root";
...
// Other parameters
TString etaTag("recoIDEle_abseta");
TString ptTag("recoIDEle_pt");
TString allTag("recoIDEle_1bin");

// Automatic parameters (shouldn't require modification by the user)
const int nAbsEtaBins = 2;
TString cutTag("eleTree"); 
TString cutLegend("ele reco+ID");
TString absetaTag("recoIDEle_EBEE");
...
void TnPEffDraw() {
  ...
  TGraphAsymmErrors *ComEta0 = plotEff_1bin(daEtaData0, 1, "abseta");
  TGraphAsymmErrors *ComEta1 = plotEff_1bin(daEtaData1, 1, "abseta");
  ...
  TGraphAsymmErrors* Com0Pt0 = plotEff_1bin(daPtMC1Bin0,0,"abseta");
  TGraphAsymmErrors* Com0Pt1 = plotEff_1bin(daPtData1Bin0,0,"abseta");
